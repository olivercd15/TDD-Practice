...
namespace Testing
{
    ...
    public sealed class TestCalculoDescuentos
    {
        ...
        public void Calcular_Descuento_Cliente_Producto_Simple()
        {
            ...
            var cliente = new Cliente(1, "C001", "Juan Pérez", grupoCliente.Id, grupoCliente);
            ...
            // Act
            var descuentoTotal = (grupoCliente.PorcentajeDescuento ?? 0) + (grupoProducto.PorcentajeDescuento ?? 0); // 8 + 3 = 11%
            var precioUnitario = producto.PrecioVenta; // 990
            var descuentoAplicado = Math.Round((precioUnitario * descuentoTotal) / 100, 2);
            ...
            Assert.AreEqual(11, descuentoTotal);
        ...
        public void Calcular_Descuento_Cliente_De_3_Productos()
        {
            ...
            // Act
            var descuentoTotal = (grupoCliente.PorcentajeDescuento ?? 0) + (grupoProducto.PorcentajeDescuento ?? 0); 
            var precioUnitario = producto.PrecioVenta;
            var cantidad = 3;
            var descuentoUnitario = Math.Round((precioUnitario * descuentoTotal) / 100, 2); 
        ...
        public void Calcular_Descuento_Cliente_Con_Tres_Productos_Distintos()
        {
            ...
            var descuentoTotal1 = (grupoCliente.PorcentajeDescuento ?? 0) + (grupoProducto1.PorcentajeDescuento ?? 0); // 11%
            var descuentoUnitario1 = Math.Round(producto1.PrecioVenta * descuentoTotal1 / 100, 2); // 108.90
            ...
            var descuentoTotal2 = (grupoCliente.PorcentajeDescuento ?? 0) + (grupoProducto2.PorcentajeDescuento ?? 0); // 13%
            var descuentoUnitario2 = Math.Round(producto2.PrecioVenta * descuentoTotal2 / 100, 2); // 780.00
            ...
            var descuentoTotal3 = (grupoCliente.PorcentajeDescuento ?? 0) + (grupoProducto3.PorcentajeDescuento ?? 0); // 18%
            var descuentoUnitario3 = Math.Round(producto3.PrecioVenta * descuentoTotal3 / 100, 2); // 45.00
